...
/*
                                if (rect.height > 160 && rect.height < 170) {
                                    Core.putText(frame, "Ishaan", //this prints the shit 
                                ...
                                else if (rect.height > 100 && rect.height < 110) {
                                    Core.putText(frame, "Seb", //this prints the shit 
                                            new Point(rect.x, rect.y + 50), 1, 1, new Scalar(255, 255, 255));
                                    myThread.runnable = false;            // stop thread
                                    jButton2.setEnabled(false);   // activate start button 
                                    jButton1.setEnabled(true);     // deactivate stop button
                                    ...
                                    Core.putText(frame, "DANIAL", //this prints the shit 
                                            new Point(rect.x, rect.y + 50), 1, 1, new Scalar(255, 255, 255));
                                    myThread.runnable = false;            // stop thread
                                    jButton2.setEnabled(false);   // activate start button 
                                    jButton1.setEnabled(true);     // deactivate stop button
                                ...
                                else if (rect.height > 120 && rect.height < 130) {
                                    Core.putText(frame, "ERINN", //this prints the shit 
                                            new Point(rect.x, rect.y + 50), 1, 1, new Scalar(255, 255, 255));
                                    myThread.runnable = false;            // stop thread
                                    jButton2.setEnabled(false);   // activate start button 
                                    jButton1.setEnabled(true);     // deactivate stop button
